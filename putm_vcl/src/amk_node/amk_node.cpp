...
bool AmkNode::check_dc_on()
{
  ...
  return (amk_rear_left_actual_values1.amk_status.quit_dc_on) == true;
}
...
{
  return ( amk_rear_left_actual_values1.amk_status.system_ready) == true;
}
...
bool AmkNode::all_inv_on()
{
  ...
  return (amk_rear_left_actual_values1.amk_status.quit_inverter_on ||
          amk_rear_left_actual_values1.amk_status.quit_dc_on ||
          amk_rear_left_actual_values1.amk_status.inverter_on || 
          amk_rear_left_actual_values1.amk_status.dc_on || rtd.state) == false;
}
...
void AmkNode::on_update(StateMachine state)
{
  ...
  case StateMachine::TORQUE_CONTROL:
    ...
    if ( amk_rear_left_actual_values1.actual_velocity > 20000 ){
